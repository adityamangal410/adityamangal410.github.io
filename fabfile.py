...
def live_build(port=8080):
    ...
    server.watch('../content/articles/*.rmd',  # 5
        livereload.shell('pelican -s ../pelicanconf.py -o ../output'))  # 6
...
def build_rmd():  # 1
    """Compile all .Rmd files in _R directory into .md files in articles directory"""
    local('cd content && Rscript --vanilla ../knitpages.R && cd ..')
