#/Users/amangal/anaconda3/envs/portfolio/bin/Rscript --vanilla

# compiles all .Rmd files in _R directory into .md files in articles directory,
...
figsfolder = "figure/"
cachefolder = "_caches"
knit_folder(infolder, outfolder, figsfolder, cachefolder)
